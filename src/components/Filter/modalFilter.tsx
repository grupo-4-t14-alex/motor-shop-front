...
export const ModalFilter = ({isOpen, onClose}: Props) => {
    return (
        <ModalContainer title="Filtro" variant="filterVariant" isOpen={isOpen} onClose={onClose}>
            <Flex
                mb="100px"
                w={"100%"}
                mt="40px"
            ...
            <ModalFooter>
                <Button onClick={onClose}>Ver Anúncios</Button>
            </ModalFooter>
        </ModalContainer>
    )
}