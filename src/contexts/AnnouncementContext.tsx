...
import { Car2, CarData, IcreateAnnounce } from "../components/formCreateAnnouncement/validators";
...
export const AnnouncementProvider = ({ children }: AnnouncementProviderProps) => {
  ...
  return (
    <AnnouncementContext.Provider value={{ ops1 ,handlerModel, handlerBrand ,CreateAnnouncement, onError, resApiForm, setResApiForm, resApiForm2, setResApiForm2, marca, setMarca, model, setModel,arrayFuel  }}>
      {children}
